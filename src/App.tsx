...
//   bazar: number;
//   totalMeals: number;
//   houseRent: number; // Added individual house rent
// }
...
//     { id: "1", name: "Asif", bazar: 2537, totalMeals: 43, houseRent: 2750 },
//     { id: "2", name: "Noman", bazar: 1520, totalMeals: 40.5, houseRent: 2750 },
//     { id: "3", name: "Omar", bazar: 1590, totalMeals: 43.5, houseRent: 2000 },
//     { id: "4", name: "Monir", bazar: 2200, totalMeals: 11, houseRent: 2000 },
...
//                   <Users className="text-indigo-600" size={24} /> Member Inputs
//                 </h2>
//                 <button
//                   onClick={addMember}
...
//                     <tr>
//                       <th className="p-4 rounded-l-lg">Member</th>
...
//             {/* Others/Utility Section */}
//             <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
//               <div className="flex justify-between items-center mb-4">
//                 <h2 className="text-lg font-bold flex items-center gap-2 text-slate-700">
//                   <Settings className="text-slate-500" size={20} /> Shared Bills
//                 </h2>
//                 <button
//                   onClick={addUtility}
...
//                       onClick={() =>
//                         setUtilities(
//                           utilities.filter((item) => item.id !== u.id)
//                         )
//                       }
...
//                 * Shared bills are divided equally among all members.
//               </p>
//             </div>
//           </div>
//         </div>
...
//       useCORS: true,
//       logging: false,
//       backgroundColor: "#f8fafc", // slate-50 hex code
//       // This part prevents the oklch error by filtering the cloned document
//       onclone: (clonedDoc) => {
//         const reportElement = clonedDoc.getElementById("pdf-report-content");
//         if (reportElement) {
//           // You can force specific styles here if needed
...
//     pdf.save("mess-report.pdf");
//   } catch (error) {
//     console.error("PDF Generation Error:", error);
//     alert(
//       "There was an issue generating the PDF. Try using a simpler color theme."
//     );
//   }
// };
